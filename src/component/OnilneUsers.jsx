...
import { deleteTheUser, getOnlineUsers } from '../Services/Users';
...
const OnilneUsers = () => {
    ...
    const UserApiFunc = async () => {
        const userResp = await getOnlineUsers("");
                ...
                <div className='actionContent'>
                    ...
                    <div className="dropdown">
                        <div className="dropdown-content">
                            ...
                            <Link to={`/manage-user/user-detail/${row.id}`}><img className='dropMainIcon' src="/assets/images/icons/action_icon_view.svg" alt="" /><img className='dropMainIcon2' src="/assets/images/white_icon/view icon.png" alt="" />View</Link>
                        </div>
                    </div>
                </div>
            )
    ...
    const searchFunc = async (e) => {
        const resp = await getOnlineUsers(e);
